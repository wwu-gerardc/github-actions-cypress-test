(function(window, document, undefined) {
  ...
  if (generateButton) {
    generateButton.onclick = function() {
      ...
      if (phone_one) {
        document.getElementById("field_phone_one").innerHTML = ' <span aria-hidden="true">|</span> <a href="tel:' + phone_one + '">' + phone_one + "</a>";
      } else {
        document.getElementById("field_phone_one").innerHTML = "";
      }
      if (phone_two) {
        document.getElementById("field_phone_two").innerHTML = ' <span aria-hidden="true">|</span> <a href="tel:' + phone_two + '">' + phone_two + "</a>";
      } else {
        document.getElementById("field_phone_two").innerHTML = "";
      }
      if (teams_id) {
        document.getElementById("field_teams_id").innerHTML = ' <span aria-hidden="true">|</span> <a href="https://teams.microsoft.com/l/chat/0/0?users=' + teams_id + '@wwu.edu">Message me on Teams</a>';
      } else {
        document.getElementById("field_teams_id").innerHTML = "";
      }
      if (mail_stop) {
        document.getElementById("field_mail_stop").innerHTML = ' <span aria-hidden="true">|</span> MS' + mail_stop;
      } else {
