  ...
  if ((typeof context == "undefined" || typeof context != "undefined" && context == document) && typeof window !== "undefined") {
    ...
    class WWUHeader extends HTMLElement {
      ...
      connectedCallback() {
        ...
        const site_content = [ this.querySelector(".site-info"), document.querySelector(".page-content") ];
        const mobile_menu = [ this.querySelector(".wwu-menu"), document.querySelector(".main-navigation"), document.querySelector(".main-nav") ];
        // Wordpress
