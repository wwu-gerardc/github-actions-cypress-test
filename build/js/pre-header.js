  ...
  Drupal.behaviors.pre_header = {
    attach: function(context, settings) {
      ...
      --------------------------------------------------------------------------*/            const search = document.createElement("wwu-search");
            ...
            if (this.getAttribute("search-profile") != null) {
              search.setAttribute("profile", this.getAttribute("search-profile"));
            }
      ...
      --------------------------------------------------------------------------*/            var display_toggle = this.querySelector(".toggle-settings");
            ...
            /* Open the menu -------------------------------------------------------------*/            function open_display_settings() {
            ...
            /* Close the menu -------------------------------------------------------------*/            function close_display_settings() {
            ...
            function click_outside(event) {
              ...
              if (settings_menu.classList.contains("open") && !isClickInside && !isClickToggle) {
                close_display_settings();
              }
            }
          ...
          ---------------------------------------------------------------------------*/            function set_initial_theme(system_theme) {
            ...
            function global_reset(event) {
              ...
              if (event.target == reset_preferences) {
                if (current_theme_value !== "default-theme" || current_font_value !== "font--default") {
                  var theme_default = theme_options.querySelector('input[value="default-theme"]');
                  var font_default = font_options.querySelector('input[value="font--default"]');
                  try {
                    localStorage.setItem("wwu_preferred_theme", "default-theme");
                    localStorage.setItem("wwu_preferred_font", "font--default");
                  } catch (e) {
                  ...
                  body.classList.remove("font--dyslexia-friendly", "font--hyperlegible", "font--serif");
